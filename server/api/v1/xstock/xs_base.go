...
import (
	"xs/global"
	"xs/model/common/response"
	model_xstock "xs/model/xstock"
...
// @Param     data  body     model_xstock.BankReq                                        true  "无"
// @Success   200   {object}  response.Response{data=model_xstock.FutureClsResp,msg=string}  "品种列表"
// @Router    /xstock/getFutureClsList [post]
func (e *BaseApi) GetFutureClsList(c *gin.Context) {
	var req model_xstock.BankReq
	err := c.ShouldBindJSON(&req)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
	resp := &model_xstock.FutureClsResp{}
	err = resp.GetData()
	if err != nil {
...
// @Success   200   {object}  response.Response{data=model_xstock.PredListResp,msg=string}  "预测数据列表"
// @Router    /xstock/getPredList [post]
func (e *BaseApi) GetPredList(c *gin.Context) {
	...
	resp := &model_xstock.PredListResp{}
...
// func (e *BaseApi) CreateExaCustomer(c *gin.Context) {
