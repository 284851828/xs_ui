...
const docTemplate_swagger = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/xstock.BankReq"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/xstock.FutureClsResp"
                                        },
                                        "msg": {
                                            "type": "string"
                                        }
    ...
    "definitions": {
        ...
        "xstock.FutureClsResp": {
            "type": "object",
            "properties": {
                "records": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/xstock.FutureCls"
                    }
                }
            }
        },
